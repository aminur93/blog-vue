...
<head>
    ...
    <link href="{{asset("assets/user/css/")}}/bootstrap-responsive.css" rel="stylesheet" />
    <link href="{{asset("assets/user/css/")}}/fancybox/jquery.fancybox.css" rel="stylesheet">
    <link href="{{asset("assets/user/css/")}}/jcarousel.css" rel="stylesheet" />
    <link href="{{asset("assets/user/css/")}}/flexslider.css" rel="stylesheet" />
    <link href="{{asset("assets/user/css/")}}/style.css" rel="stylesheet" />
    <!-- Theme skin -->
    <link href="{{ asset("assets/user/skins/") }}/default.css" rel="stylesheet" />
    <!-- Fav and touch icons -->
    ...
    <link rel="apple-touch-icon-precomposed" href="/assets/user/ico/apple-touch-icon-57-precomposed.png" />
        ...
        <header>
            <div class="container ">
                ...
                <div class="row">
                    <div class="span4">
                        <div class="logo">
                            <a href="index.html"><img src="{{asset("assets/user/img/")}}/logo.png" alt="" class="logo" /></a>
...
<script src="{{asset("assets/user/js/")}}/jcarousel/jquery.jcarousel.min.js"></script>
<script src="{{asset("assets/user/js/")}}/jquery.fancybox.pack.js"></script>
<script src="{{asset("assets/user/js/")}}/jquery.fancybox-media.js"></script>
<script src="{{asset("assets/user/js/")}}/google-code-prettify/prettify.js"></script>
<script src="{{asset("assets/user/js/")}}/portfolio/jquery.quicksand.js"></script>
<script src="{{asset("assets/user/js/")}}/portfolio/setting.js"></script>
<script src="{{asset("assets/user/js/")}}/jquery.flexslider.js"></script>
<script src="{{asset("assets/user/js/")}}/jquery.nivo.slider.js"></script>
<script src="{{asset("assets/user/js/")}}/modernizr.custom.js"></script>
<script src="{{asset("assets/user/js/")}}/jquery.ba-cond.min.js"></script>
<script src="{{asset("assets/user/js/")}}/jquery.slitslider.js"></script>
